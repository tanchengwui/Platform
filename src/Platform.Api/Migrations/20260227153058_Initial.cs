    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppDrafts", x => x.DraftId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SemVer = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnvId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppVersionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RequestedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StartedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    FinishedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    LogRef = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DraftResources", x => x.ResourceId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EnvAppId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EnvId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ActiveAppVersionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EnvironmentApps", x => x.EnvAppId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apps_TenantId_Key",
                table: "Apps",
                columns: new[] { "TenantId", "Key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DraftResources_DraftId_Type_Key",
                table: "DraftResources",
                columns: new[] { "DraftId", "Type", "Key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EnvironmentApps_EnvId_AppId",
                table: "EnvironmentApps",
                columns: new[] { "EnvId", "AppId" },
                unique: true);
